                  ...
                  <td className="p-6 text-left">
                    {q.status === 'pending' ? (
                      <div className="flex justify-end gap-2">
                        <button onClick={() => handleUpdateStatus(q.id, 'approved')} className="p-2 bg-green-500/10 text-green-500 hover:bg-green-500 hover:text-gray-900 rounded transition-colors" title="قبول">
                          <Check size={16} />
                        </button>
                        <button onClick={() => handleUpdateStatus(q.id, 'rejected')} className="p-2 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-gray-900 rounded transition-colors" title="رفض">
                          <X size={16} />
                        </button>
                      </div>
                    ) : q.status === 'approved' ? (
